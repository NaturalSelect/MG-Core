        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Introduction = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false),
                    JumpURL = table.Column<string>(type: "longtext", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PowerUserId = table.Column<string>(type: "varchar(127)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Block", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Block_AspNetUsers_PowerUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    BlockId = table.Column<string>(type: "varchar(127)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Time = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    UserNameId = table.Column<string>(type: "varchar(127)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Reply_AspNetUsers_UserNameId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Block_PowerUserId",
                table: "Block",
                column: "PowerUserId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Post_BlockId",
                table: "Post",
                column: "BlockId");
